...
#define TEST_TEST_TOUCH_TRIM_OFFSET                             0x0050
...
#define TEST_TEST_TOUCH_TRIM_ADDR                               ( TEST_BASE_ADDR + TEST_TEST_TOUCH_TRIM_OFFSET)
...
#define TEST_TEST_TOUCH_TRIM_TOUCH_IDAC_TRIM_SHIFT                                0
#define TEST_TEST_TOUCH_TRIM_TOUCH_IDAC_TRIM_MASK                                 0x0000000F
#define TEST_TEST_TOUCH_TRIM_TOUCH_IDAC_TRIM_SET(n)                               (((uint32_t)(n) << 0  ) & 0x0000000F)
#define TEST_TEST_TOUCH_TRIM_TOUCH_IDAC_TRIM_CLR                                  0xFFFFFFF0
...
typedef struct
{
    __IO uint32_t TOUCH_IDAC_TRIM        : 4  ; // 3  : 0
    __IO uint32_t RESERVED0              : 28 ; // 31 : 4
} TEST_TEST_TOUCH_TRIM_FIELD_T;
...
typedef struct
{
    ...
    union
    {
        __IO  uint32_t TEST_TOUCH_TRIM                               ; // 0x0050
        TEST_TEST_TOUCH_TRIM_FIELD_T TEST_TOUCH_TRIM_F               ;
    };
