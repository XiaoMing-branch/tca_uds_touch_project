...
#define ASYSCFG_LDO12C_CTRL_OFFSET                              0x0048
...
#define ASYSCFG_LDO12C_CTRL_ADDR                                ( ASYSCFG_BASE_ADDR + ASYSCFG_LDO12C_CTRL_OFFSET)
...
#define ASYSCFG_PMU_IRQ_CTRL_LDO12C_OCP_IRQ_MODE_SHIFT                           8
#define ASYSCFG_PMU_IRQ_CTRL_LDO12C_OCP_IRQ_MODE_MASK                            0x00000700
#define ASYSCFG_PMU_IRQ_CTRL_LDO12C_OCP_IRQ_MODE_SET(n)                          (((uint32_t)(n) << 8  ) & 0x00000700)
#define ASYSCFG_PMU_IRQ_CTRL_LDO12C_OCP_IRQ_MODE_CLR                             0xFFFFF8FF
...
#define ASYSCFG_IMR_LDO12C_RDY_INT_MSK_SHIFT                                     4
#define ASYSCFG_IMR_LDO12C_RDY_INT_MSK_MASK                                      0x00000010
#define ASYSCFG_IMR_LDO12C_RDY_INT_MSK_SET(n)                                    (((uint32_t)(n) << 4  ) & 0x00000010)
#define ASYSCFG_IMR_LDO12C_RDY_INT_MSK_CLR                                       0xFFFFFFEF

#define ASYSCFG_IMR_LDO12C_OCP_INT_MSK_SHIFT                                     3
#define ASYSCFG_IMR_LDO12C_OCP_INT_MSK_MASK                                      0x00000008
#define ASYSCFG_IMR_LDO12C_OCP_INT_MSK_SET(n)                                    (((uint32_t)(n) << 3  ) & 0x00000008)
#define ASYSCFG_IMR_LDO12C_OCP_INT_MSK_CLR                                       0xFFFFFFF7
...
#define ASYSCFG_ICR_LDO12C_RDY_INT_CLR_SHIFT                                     4
#define ASYSCFG_ICR_LDO12C_RDY_INT_CLR_MASK                                      0x00000010
#define ASYSCFG_ICR_LDO12C_RDY_INT_CLR_SET(n)                                    (((uint32_t)(n) << 4  ) & 0x00000010)
#define ASYSCFG_ICR_LDO12C_RDY_INT_CLR_CLR                                       0xFFFFFFEF

#define ASYSCFG_ICR_LDO12C_OCP_INT_CLR_SHIFT                                     3
#define ASYSCFG_ICR_LDO12C_OCP_INT_CLR_MASK                                      0x00000008
#define ASYSCFG_ICR_LDO12C_OCP_INT_CLR_SET(n)                                    (((uint32_t)(n) << 3  ) & 0x00000008)
#define ASYSCFG_ICR_LDO12C_OCP_INT_CLR_CLR                                       0xFFFFFFF7
...
#define ASYSCFG_ISR_LDO12C_RDY_INT_STATUS_SHIFT                                  4
#define ASYSCFG_ISR_LDO12C_RDY_INT_STATUS_MASK                                   0x00000010
#define ASYSCFG_ISR_LDO12C_RDY_INT_STATUS_SET(n)                                 (((uint32_t)(n) << 4  ) & 0x00000010)
#define ASYSCFG_ISR_LDO12C_RDY_INT_STATUS_CLR                                    0xFFFFFFEF

#define ASYSCFG_ISR_LDO12C_OCP_INT_STATUS_SHIFT                                  3
#define ASYSCFG_ISR_LDO12C_OCP_INT_STATUS_MASK                                   0x00000008
#define ASYSCFG_ISR_LDO12C_OCP_INT_STATUS_SET(n)                                 (((uint32_t)(n) << 3  ) & 0x00000008)
#define ASYSCFG_ISR_LDO12C_OCP_INT_STATUS_CLR                                    0xFFFFFFF7
...
#define ASYSCFG_IRSR_LDO12C_RDY_INT_RAW_STATUS_SHIFT                             4
#define ASYSCFG_IRSR_LDO12C_RDY_INT_RAW_STATUS_MASK                              0x00000010
#define ASYSCFG_IRSR_LDO12C_RDY_INT_RAW_STATUS_SET(n)                            (((uint32_t)(n) << 4  ) & 0x00000010)
#define ASYSCFG_IRSR_LDO12C_RDY_INT_RAW_STATUS_CLR                               0xFFFFFFEF

#define ASYSCFG_IRSR_LDO12C_OCP_INT_RAW_STATUS_SHIFT                             3
#define ASYSCFG_IRSR_LDO12C_OCP_INT_RAW_STATUS_MASK                              0x00000008
#define ASYSCFG_IRSR_LDO12C_OCP_INT_RAW_STATUS_SET(n)                            (((uint32_t)(n) << 3  ) & 0x00000008)
#define ASYSCFG_IRSR_LDO12C_OCP_INT_RAW_STATUS_CLR                               0xFFFFFFF7
...
#define ASYSCFG_LDO12C_CTRL_LDO12C_HW_EN_CLR_SHIFT                               21
#define ASYSCFG_LDO12C_CTRL_LDO12C_HW_EN_CLR_MASK                                0x00200000
#define ASYSCFG_LDO12C_CTRL_LDO12C_HW_EN_CLR_SET(n)                              (((uint32_t)(n) << 21 ) & 0x00200000)
#define ASYSCFG_LDO12C_CTRL_LDO12C_HW_EN_CLR_CLR                                 0xFFDFFFFF

#define ASYSCFG_LDO12C_CTRL_LDO12C_WKUP_EN_SHIFT                                 20
#define ASYSCFG_LDO12C_CTRL_LDO12C_WKUP_EN_MASK                                  0x00100000
#define ASYSCFG_LDO12C_CTRL_LDO12C_WKUP_EN_SET(n)                                (((uint32_t)(n) << 20 ) & 0x00100000)
#define ASYSCFG_LDO12C_CTRL_LDO12C_WKUP_EN_CLR                                   0xFFEFFFFF

#define ASYSCFG_LDO12C_CTRL_LDO12C_RDY_CNT_MAX_SHIFT                             12
#define ASYSCFG_LDO12C_CTRL_LDO12C_RDY_CNT_MAX_MASK                              0x0003F000
#define ASYSCFG_LDO12C_CTRL_LDO12C_RDY_CNT_MAX_SET(n)                            (((uint32_t)(n) << 12 ) & 0x0003F000)
#define ASYSCFG_LDO12C_CTRL_LDO12C_RDY_CNT_MAX_CLR                               0xFFFC0FFF

#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_SHIFT                                     8
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_MASK                                      0x00000100
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_SET(n)                                    (((uint32_t)(n) << 8  ) & 0x00000100)
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_CLR                                       0xFFFFFEFF

#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_DISABLE_SHIFT                             4
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_DISABLE_MASK                              0x00000010
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_DISABLE_SET(n)                            (((uint32_t)(n) << 4  ) & 0x00000010)
#define ASYSCFG_LDO12C_CTRL_LDO12C_OCP_DISABLE_CLR                               0xFFFFFFEF

#define ASYSCFG_LDO12C_CTRL_LDO12C_PULL_DOWN_SHIFT                               1
#define ASYSCFG_LDO12C_CTRL_LDO12C_PULL_DOWN_MASK                                0x00000002
#define ASYSCFG_LDO12C_CTRL_LDO12C_PULL_DOWN_SET(n)                              (((uint32_t)(n) << 1  ) & 0x00000002)
#define ASYSCFG_LDO12C_CTRL_LDO12C_PULL_DOWN_CLR                                 0xFFFFFFFD

#define ASYSCFG_LDO12C_CTRL_LDO12C_EN_SHIFT                                      0
#define ASYSCFG_LDO12C_CTRL_LDO12C_EN_MASK                                       0x00000001
#define ASYSCFG_LDO12C_CTRL_LDO12C_EN_SET(n)                                     (((uint32_t)(n) << 0  ) & 0x00000001)
#define ASYSCFG_LDO12C_CTRL_LDO12C_EN_CLR                                        0xFFFFFFFE
...
typedef struct
{
    ...
    __IO uint32_t RESERVED1                 : 1  ; // 7  : 7
    __IO uint32_t LDO12C_OCP_IRQ_MODE       : 3  ; // 10 : 8
...
typedef struct
{
    ...
    __IO uint32_t LDO12C_OCP_INT_MSK        : 1  ; // 3  : 3
    __IO uint32_t LDO12C_RDY_INT_MSK        : 1  ; // 4  : 4
...
typedef struct
{
    ...
    __IO uint32_t LDO12C_OCP_INT_CLR        : 1  ; // 3  : 3
    __IO uint32_t LDO12C_RDY_INT_CLR        : 1  ; // 4  : 4
    __IO uint32_t RESERVED0                 : 27 ; // 31 : 5
} ASYSCFG_ICR_FIELD_T;
...
typedef struct
{
    ...
    __IO uint32_t LDO12C_OCP_INT_STATUS     : 1  ; // 3  : 3
    __IO uint32_t LDO12C_RDY_INT_STATUS     : 1  ; // 4  : 4
    __IO uint32_t RESERVED0                 : 27 ; // 31 : 5
} ASYSCFG_ISR_FIELD_T;
...
typedef struct
{
    ...
    __IO uint32_t LDO12C_OCP_INT_RAW_STATUS : 1  ; // 3  : 3
    __IO uint32_t LDO12C_RDY_INT_RAW_STATUS : 1  ; // 4  : 4
    __IO uint32_t RESERVED0                 : 27 ; // 31 : 5
...
typedef struct
{
    __IO uint32_t LDO12C_EN                 : 1  ; // 0  : 0
    __IO uint32_t LDO12C_PULL_DOWN          : 1  ; // 1  : 1
    __IO uint32_t RESERVED4                 : 2  ; // 3  : 2
    __IO uint32_t LDO12C_OCP_DISABLE        : 1  ; // 4  : 4
    __IO uint32_t RESERVED3                 : 3  ; // 7  : 5
    __IO uint32_t LDO12C_OCP                : 1  ; // 8  : 8
    __IO uint32_t RESERVED2                 : 3  ; // 11 : 9
    __IO uint32_t LDO12C_RDY_CNT_MAX        : 6  ; // 17 : 12
    __IO uint32_t RESERVED1                 : 2  ; // 19 : 18
    __IO uint32_t LDO12C_WKUP_EN            : 1  ; // 20 : 20
    __IO uint32_t LDO12C_HW_EN_CLR          : 1  ; // 21 : 21
    __IO uint32_t RESERVED0                 : 10 ; // 31 : 22
} ASYSCFG_LDO12C_CTRL_FIELD_T;
...
typedef struct
{
    ...
    union
    {
        __IO  uint32_t LDO12C_CTRL                     ; // 0x0048
        ASYSCFG_LDO12C_CTRL_FIELD_T LDO12C_CTRL_F      ;
    };
