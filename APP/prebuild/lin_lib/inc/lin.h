...
#define TX_QUEUE_DEFAULT      0
#define TX_QUEUE_COVER        1
#define LIN_TX_QUEUE_TYPE     TX_QUEUE_COVER
...
#define SERVICE_CONTROL_DTC_SETTING       0x85      /**< service I/O control */
...
#define SERVICE_LED_GET_CONFIG            0xBA      /**< led get config service */
#define SERVICE_LED_SET_CONFIG            0xBB      /**< led set config service */
#define SERVICE_SOC_REG_RD                0xBC
#define SERVICE_SOC_REG_WR                0xBD
#define SERVICE_GET_TRACEABILITY_MSG      0x32
...
#define SERVICE_TESTER_PRESENT            0x3E      /**< service tester present */
...
extern uint8_t program_condition_check;
...
#define LIN_SLEEP_MODE      0x0A          /**< sleep mode state */
...
typedef struct
{
    ...
    l_s32 response_error;             /**< Signal used to update response error */
    ...
    const l_s32 *fault_state_signal;  /**< List of fault state signal */
    l_u16 P2_min;                               /**< P2 min */
    l_u16 ST_min;                               /**< ST min */
...
*/
#if (LIN_MODE == _MASTER_MODE_)
extern  lin_pid_response_callback_handler(l_ifc_handle iii, lin_lld_event_id event_id, l_u8 pid);
#define CALLBACK_HANDLER(iii, event_id, pid) lin_pid_response_callback_handler((iii), (event_id), (pid))
#else
extern void lin_pid_response_callback_handler(lin_lld_event_id event_id, l_u8 pid);
...
void lin_lld_set_etf_collision_flag(l_ifc_handle iii);
void lin_lld_clear_etf_collision_flag(l_ifc_handle iii);
...
/*****************************************************************/
/*****    Common variables    *****/
extern const lin_frame_struct   lin_frame_tbl[];
extern l_bool                   lin_frame_flag_tbl[];
extern l_u8                     lin_pFrameBuf[];
extern l_u8                     lin_flag_handle_tbl[];
extern volatile l_u8            buffer_backup_data[8];
extern volatile l_u8            lin_frame_updating_flag_tbl[];
...
/* diagnostic flag */
extern const l_u8 lin_diag_services_supported[];
extern l_u8 lin_diag_services_flag[];
extern const  lin_frame_struct    lin_frame_tbl[];
...
extern l_u8                       lin_diag_signal_tbl[];
...
extern l_u16                lin_configuration_ROM[];  /* Configuration stores in ROM */
...
extern l_u16                      lin_response_error_byte_offset[];/*<interface_name>_< response_error>*/
extern l_u8                       lin_response_error_bit_offset[];/*<interface_name>_< response_error>*/
...
extern void          l_ifc_aux(void);
extern l_u16         l_sys_irq_disable(void);
extern void          l_sys_irq_restore(void);
#if LIN_MODE == _SLAVE_MODE_
