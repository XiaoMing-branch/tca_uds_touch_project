...
/********************************************************
** \brief   This function configures an output gpio to keep in a specified output fixed value during low power mode
**          ONLY ONE GPIO PIN CAN BE SELECTED TO KEEP A FIXED VALUE DURING LOW POWER MODE.
**
** \param   gpio_pin_e          gpio_pin
